...
def handle_text(update, context):
    ...
    if update.message.text:
        ...
        # Try to send the responses, and catch Unauthorized exception
        try:
            ...
            context.bot.send_message(chat_id=TEXT_Group_CHAT_ID, text=f"This use has blocked the bot")
...
def handle_photo(update, context):
    ...
    try:
        # Your photo message handling code here
        ...
        # Handle the case where the user has blocked the bot
        print(f"{user_info} - User has blocked the bot after sending a photo")
