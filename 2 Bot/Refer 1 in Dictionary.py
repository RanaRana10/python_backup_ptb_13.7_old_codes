...
def get_referral_link(update, context):
    ...
    # rubot = f"t.me/RanaUniverse"
    # rubot = "tg://user?id=6690362261"   #This Code work well 😊
    # rubot = f"tg://resolve?domain=Fake999Bot"
    # rubot = "tg://msg?id=6690362261&text=Hello"
    # rubot = "tg://join?invite=https://t.me/RanaUniverse"
    # rubot = "tg://settings/language"
    rubot = "tg://settings/auto_delete"
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("Channel", url=rubot)],
]
