...
def start(update, context):
    ...
    user_info = f"Username: @{update.message.from_user.username}, Name: {update.message.from_user.first_name} {update.message.from_user.last_name or ''}"
...
def handle_photo(update, context):
    ...
    keyboard = [
        [
            InlineKeyboardButton("Google", url="https://www.google.com"),
            InlineKeyboardButton("Facebook", url="https://www.facebook.com"),
            InlineKeyboardButton("Facebookll", url="https://www.facebook.com"),
        ],
        [
            InlineKeyboardButton("Twitter", url="https://www.twitter.com"),
            InlineKeyboardButton("YouTube", url="https://www.youtube.com"),
    ...
    context.bot.send_photo(chat_id=update.message.chat_id, photo=update.message.photo[-1], caption="This is <b>the</b> caption you want to add below the photo.",reply_markup=reply_markup, parse_mode='HTML')
